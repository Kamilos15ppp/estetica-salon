...
const Contact: NextPage = () => {
  return (
    <AnimationPageWrapper className={styles.container}>
      <PageHeader>{M.contact.header}</PageHeader>
        ...
        <div className={styles.info}>
          ...
          <div className={styles.reservationContainer}>
            <p className={styles.reservation}>
              {M.contact.reservation.toUpperCase()}:
            </p>
            <p className={styles.telephone}>
              <a href={`tel:${M.contact.telephoneNumber}`}>
                {M.contact.telephoneNumber}
              </a>
            </p>
            <p className={styles.email}>
              {M.contact.emailText}:{' '}
              <span>
                <a href={`mailto:${M.contact.emailAddress}`}>
          ...
          <div className={styles.openHoursWrapper}>
            <p className={styles.openHoursHeader}>
              {M.contact.openHoursText.toUpperCase()}:
            </p>
