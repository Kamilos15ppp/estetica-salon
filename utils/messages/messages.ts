const telephoneNumber = '798-892-438';
...
export const messages = {
  ...
  contact: {
    ...
    subHeader1: 'Salon Kosmetyczny Estetica',
    subHeader2: 'Kosmetologia Pielęgnacyjno-Lecznicza',
    reservation: 'Rezerwacja telefoniczna',
    telephoneNumber,
    emailText: 'e-mail',
    emailAddress: 'estetica.rokiciny@gmail.com',
